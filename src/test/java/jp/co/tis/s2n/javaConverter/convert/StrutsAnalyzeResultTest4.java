 ...
 *
 */
public class StrutsAnalyzeResultTest4 extends ConvertTest {
    ...
    public static void setUp() throws Exception {
        ...
        activeProfile.setProjectPath("src/test/resources/StrutsAnalyzeResultTest4/java");
        ...
        String[] strutsConfigFiles = new String[] {
                "src/test/resources/StrutsAnalyzeResultTest4/conf/struts-config.xml" };
        String[] validationFile = new String[] {
                "src/test/resources/StrutsAnalyzeResultTest4/conf/validation.xml" };
