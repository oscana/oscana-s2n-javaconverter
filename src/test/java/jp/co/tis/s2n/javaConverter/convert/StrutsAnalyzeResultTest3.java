 ...
 *
 */
public class StrutsAnalyzeResultTest3 extends ConvertTest {
    ...
    public static void setUp() throws Exception {
        ...
        activeProfile.setProjectPath("src/test/resources/StrutsAnalyzeResultTest3/java");
        ...
        String[] strutsConfigFiles = new String[] {
                "src/test/resources/StrutsAnalyzeResultTest3/conf/struts-config.xml" };
        String[] validationFile = new String[] {
                "src/test/resources/StrutsAnalyzeResultTest3/conf/validation.xml" };
     ...
     */
    @Test
    public void testStrutsForm() throws Exception {
