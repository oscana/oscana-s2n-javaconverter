 ...
 *
 */
public class StrutsAnalyzeResultTest extends ConvertTest {
    ...
    public static void setUp() throws Exception {
        ...
        activeProfile.setProjectPath("src/test/resources/StrutsAnalyzeResultTest/java");
        ...
        String[] strutsConfigFiles = new String[] {
                "src/test/resources/StrutsAnalyzeResultTest/conf/struts-config.xml" };
        String[] validationFile = new String[] {
                "src/test/resources/StrutsAnalyzeResultTest/conf/validation.xml" };
