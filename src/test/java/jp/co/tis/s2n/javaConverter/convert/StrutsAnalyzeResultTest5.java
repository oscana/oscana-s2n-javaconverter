 ...
 *
 */
public class StrutsAnalyzeResultTest5 extends ConvertTest {
    ...
    public static void setUp() throws Exception {
       LogUtils.init();
        ...
        activeProfile.setProjectPath("src/test/resources/StrutsAnalyzeResultTest5/java");
        ...
        String[] strutsConfigFiles = new String[] {
                "src/test/resources/StrutsAnalyzeResultTest5/conf/struts-config.xml" };
        String[] validationFile = new String[] {
                "src/test/resources/StrutsAnalyzeResultTest5/conf/validation.xml" };
