 ...
 * @author Ko Ho
 */
@Csv(headers = {"プロジェクトＩＤ","プロジェクト名","プロジェクト種別","プロジェクト開始日付","プロジェクト終了日付"},properties = {"projectId","projectNm","projectType","projectStartDate","projectEndDate"},type = Csv.CsvType.CUSTOM)
...
public class TestCsvElementSample implements Serializable {
