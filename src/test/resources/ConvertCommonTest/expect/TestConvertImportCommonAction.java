...
import oscana.s2n.struts.action.*;
 ...
 */
@RequestScoped
public class TestConvertImportCommonAction  implements Serializable{
    ...
    @OnError(type = ApplicationException.class, path = "/WEB-INF/view/testConvertImportCommon/A.jsp")
    public HttpResponse index(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( "searchList.jsp", this, nabRequest, nabContext, "TestConvertImportCommon");
    }
    ...
    public HttpResponse doSearch(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( searchList(), this, nabRequest, nabContext, "TestConvertImportCommon");
    }
    ...
    public HttpResponse indexBack(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( doSearch(nabRequest, nabContext), this, nabRequest, nabContext, "TestConvertImportCommon");
    }
