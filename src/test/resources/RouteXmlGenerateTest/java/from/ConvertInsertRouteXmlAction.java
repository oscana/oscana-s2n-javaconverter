 ...
 * @author Ko Ho
 */
public class ConvertInsertRouteXmlAction extends AbstractSearchAction {
        ...
        if (sampleSearchListForm.isEnvTypeHonban()) {
            ...
            for (Tbsample tbsample : tbsampleList) {
                ...
                if (StringUtils.isNotBlank(sample.testdata)) {
                    sample.testdata =
                        convertTest(StringUtil.trimRight(tbsample.testdata));
                }

                if (StringUtils.isNotBlank(sample.initialvector)) {
                    sample.initialvector =
                        convertTest(StringUtil.trimRight(tbsample.initialvector));
                }
            ...
            for (Tbsample bufsample : thesampleList) {
                ...
                if (StringUtils.isNotBlank(bufsample.testdata)) {
                    sample.testdata =
                        convertTest(StringUtil.trimRight(bufsample.testdata));
                }

                if (StringUtils.isNotBlank(bufsample.initialvector)) {
                    sample.initialvector =
                        convertTest(StringUtil.trimRight(bufsample.initialvector));
                }
