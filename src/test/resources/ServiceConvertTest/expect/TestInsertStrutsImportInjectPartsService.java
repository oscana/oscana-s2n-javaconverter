...
public class TestInsertStrutsImportInjectPartsService extends ChangeTestBaseService implements Serializable {
    ...
    public Ope getOpeById(Class<Ope> baseClass, String path, Object parameter) {
        ...
        return UniversalDao.findBySqlFile(baseClass,ParamFilter.sqlFileNameToKey( "jp.co.tis.service.TestInsertStrutsImportInjectParts#" + path), parameter);

    }

    public Ope getOpeByOne(Class<Ope> baseClass, String path) {
        return UniversalDao.findBySqlFile(baseClass,ParamFilter.sqlFileNameToKey( "jp.co.tis.service.TestInsertStrutsImportInjectParts#" + path),new Object[0]);

    }

    public long getCountOpeBySqlFile(String path, Object parameter) {
        return DataUtil.getCountQueryResult(DbConnectionContext.getConnection().prepareParameterizedSqlStatementBySqlId(ParamFilter.sqlFileNameToKey("jp.co.tis.service.TestInsertStrutsImportInjectParts#" + path), parameter).executeQueryByMap(parameter));
    ...
    public List<Ope> getOpeListByWhere(Class<Ope> baseClass, String path, Object parameter) {
        ...
        return UniversalDao.findAllBySqlFile(baseClass,ParamFilter.sqlFileNameToKey( "jp.co.tis.service.TestInsertStrutsImportInjectParts#" + path), parameter);

    }

    public List<Ope> getOpeListByDefault(Class<Ope> baseClass, String path) {

        return UniversalDao.findAllBySqlFile(baseClass,ParamFilter.sqlFileNameToKey( "jp.co.tis.service.TestInsertStrutsImportInjectParts#" + path),new Object[0]);
    ...
    public List<BeanMap> findBySearchCondition(BeanMap where) {
        ...
        testMapList = DataUtil.convertToBeanMapList(UniversalDao.findAllBySqlFile(SqlRow.class,ParamFilter.sqlFileNameToKey( "jp.co.tis.service.TestInsertStrutsImportInjectParts#" + "test_2.sql"), where));
    ...
    public List<BeanMap> findByHulftJisekiAriCondition(BeanMap where) {
        ...
        List<BeanMap> testMapList = DataUtil.convertToBeanMapList(UniversalDao.findAllBySqlFile(SqlRow.class,ParamFilter.sqlFileNameToKey( "jp.co.tis.service.TestInsertStrutsImportInjectParts#" + "test_10.sql"), where));
    ...
    public long getCountBySearchCondition(BeanMap where) {
        ...
        BeanMap test = DataUtil.convertToBeanMap(UniversalDao.findBySqlFile(SqlRow.class,ParamFilter.sqlFileNameToKey( "jp.co.tis.service.TestInsertStrutsImportInjectParts#" + "test_1.sql"), where));
