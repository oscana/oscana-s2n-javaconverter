 ...
 */
@RequestScoped
public class SignatureTestAction  implements Serializable{
    ...
    @OnError(type = ApplicationException.class, path = "/WEB-INF/view/signatureTest/A.jsp")
    public HttpResponse index(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( "searchList.jsp", this, nabRequest, nabContext, "SignatureTest");
    }
    ...
    public HttpResponse doSearch(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( searchList(), this, nabRequest, nabContext, "SignatureTest");
    }
    ...
    public HttpResponse indexBack(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( doSearch(nabRequest, nabContext), this, nabRequest, nabContext, "SignatureTest");
    }
