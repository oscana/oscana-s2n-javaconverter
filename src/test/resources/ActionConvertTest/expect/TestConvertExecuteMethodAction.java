 ...
 */
@RequestScoped
public class TestConvertExecuteMethodAction  implements Serializable{
    ...
    @OnError(type = ApplicationException.class, path = "/WEB-INF/view/testConvertExecuteMethod/A.jsp")
    public HttpResponse index(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( "searchList.jsp", this, nabRequest, nabContext, "TestConvertExecuteMethod");
    }
    ...
    public HttpResponse doSearch(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( searchList(), this, nabRequest, nabContext, "TestConvertExecuteMethod");
    }
    ...
    public HttpResponse indexBack(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( doSearch(nabRequest, nabContext), this, nabRequest, nabContext, "TestConvertExecuteMethod");
    }
