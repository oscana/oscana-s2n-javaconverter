 ...
 */
@RequestScoped
public class TestInsertStrutsImportInjectPartsAction  implements Serializable{
    ...
    @OnError(type = ApplicationException.class, path = "/WEB-INF/view/testInsertStrutsImportInjectParts/A.jsp")
    public HttpResponse index(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( "searchList.jsp", this, nabRequest, nabContext, "TestInsertStrutsImportInjectParts");
    }
    ...
    public HttpResponse doSearch(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( searchList(), this, nabRequest, nabContext, "TestInsertStrutsImportInjectParts");
    }
    ...
    public HttpResponse indexBack(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( doSearch(nabRequest, nabContext), this, nabRequest, nabContext, "TestInsertStrutsImportInjectParts");
    }
