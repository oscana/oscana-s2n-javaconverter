 ...
 */
@RequestScoped
public class TestConvertTokenSkipMethodAction  implements Serializable{
    ...
    @OnError(type = ApplicationException.class, path = "/WEB-INF/view/testConvertTokenSkipMethod/A.jsp")
    public HttpResponse index(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( "searchList.jsp", this, nabRequest, nabContext, "TestConvertTokenSkipMethod");
    }
    ...
    public HttpResponse doSearch(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( searchList(), this, nabRequest, nabContext, "TestConvertTokenSkipMethod");
    }
    ...
    public HttpResponse indexBack(HttpRequest nabRequest, ExecutionContext nabContext) {
        return OscanaHttpResourceConverUtil.createHttpResponse( doSearch(nabRequest, nabContext), this, nabRequest, nabContext, "TestConvertTokenSkipMethod");
    }
