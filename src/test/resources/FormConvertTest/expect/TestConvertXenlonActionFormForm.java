 ...
 */
@SessionScoped
public class TestConvertXenlonActionFormForm extends AbstractEditForm  implements Serializable{
    ...
    @SystemChar(charsetDef = "全角文字@FullType", message = "{errors.fullType}")
    public String aaa;
