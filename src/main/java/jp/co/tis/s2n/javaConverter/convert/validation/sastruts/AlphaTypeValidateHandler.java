...
/**
 * 半角英大小文字のみかを検証するためのアノテーション。
 * @author Fumihiko Yamamoto
 *
 */
public class AlphaTypeValidateHandler extends SAStrutsAbstractValidateHandler {
    ...
    public ValidateAnnotation handle(AnnotationNodeUtil memberAnnotationNode) {
        ...
        return new FieldValidateAnnotation("SystemChar").addStringParameter("charsetDef", "\"半角英字\"")
                .addStringParameter("message", "\"{errors.alphaType}\"").addStringParameter("target", memberAnnotationNode.getStringValue("target"));
