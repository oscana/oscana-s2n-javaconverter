...
/**
 * 全角文字のみかを検証するためのアノテーション。
 * @author Fumihiko Yamamoto
 *
 */
public class FullTypeValidateHandler extends SAStrutsAbstractValidateHandler {
    ...
    public ValidateAnnotation handle(AnnotationNodeUtil memberAnnotationNode) {
        ...
        return new FieldValidateAnnotation("SystemChar").addStringParameter("charsetDef", "\"全角文字@FullType\"")
                .addRegexpStringParameter("message", "\"{errors.fullType}\"").addStringParameter("target", memberAnnotationNode.getStringValue("target"));
