...
/**
 * 半角英大小文字、半角数字、半角記号「-」のみかを検証するためのアノテーション。
 * @author Fumihiko Yamamoto
 *
 */
public class PositiveNumericHyphenTypeValidateHandler extends SAStrutsAbstractValidateHandler {
    ...
    public ValidateAnnotation handle(AnnotationNodeUtil memberAnnotationNode) {
        ...
        return new FieldValidateAnnotation("SystemChar").addStringParameter("charsetDef", "\"半角数字・半角ハイフン\"")
                .addStringParameter("message", "\"{errors.positiveNumericHyphenType}\"");
