 ...
 *
 */
public class FullHalfTypeValidateHandler extends SAStrutsAbstractValidateHandler {
    ...
    public ValidateAnnotation handle(AnnotationNodeUtil memberAnnotationNode) {
        ...
        return new FieldValidateAnnotation("SystemChar").addStringParameter("charsetDef", "\"全角半角\"")
                .addRegexpStringParameter("message", "\"{errors.fullHalfType}\"").addStringParameter("target", memberAnnotationNode.getStringValue("target"));
